...
func Run() error {
	...
	userURLsHandler := handlers.NewUserURLsHandler(useCasesURLShortener, cfg)
	...
	// Create router
	router := v1.NewRouter(createHandler, createBatchURLsHandler, getHandler, pingHandler, userURLsHandler)
	// Start server
